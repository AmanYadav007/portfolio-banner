...
window.onload = function() {   
  ...
  .from(".purple-button", 2, {x:-160, ease:Power2.easeInOut}, "frame1+=1")
  // .to(".fr1copy", .5, {alpha:0, ease:Power2.easeInOut}, "frame1+=4.5")

    /*frame two*/
	.add("frame2", "frame1+=5")
  .from(".fr2bg", 2, {y:-600, ease:Power2.easeInOut}, "frame2")
  .from(".fr2copy", 1.5, {alpha:0,y:50, ease:Power2.easeInOut}, "frame2+=1")
  .from(".white-button", 2, {x:-160, ease:Power2.easeInOut}, "frame2+=1")
  .to(".icon, .fr1copy, .rainbow-light", .5, {alpha:0, ease:Power2.easeInOut}, "frame2+=1")
  .from(".fr3bg", .5, {alpha:0, ease:Power2.easeInOut}, "frame2+=1")
  .to(".light-house", .5, {alpha:0, ease:Power2.easeInOut}, "frame2+=2")
  // .to(".glow", .5, {zIndex:1, ease:Power2.easeInOut}, "frame2+=2")
...
function toggleClass() {
  if(!isup) {
      gsap.to("#isiScroll",1, { marginTop:146,height:434, ease: Power2.easeInOut })
      gsap.to("#isiContainer",1, {height:427, ease: Power2.easeInOut })
      gsap.to(".dash1",1, { rotate:'90deg', ease: Power2.easeInOut })
      isup = true;
  } else {
  gsap.to("#isiScroll",1, { marginTop:423, ease: Power2.easeInOut })
        gsap.to("#isiContainer",1, {height:153, ease: Power2.easeInOut })
