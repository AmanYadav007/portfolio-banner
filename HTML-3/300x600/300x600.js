...
window.onload = function() {   
  ...
  .to(".light-house", .5, {width:570,top:-280, left:-249, ease:Power2.easeInOut}, "frame2+=2")
...
function toggleClass() {
  if(!isup) {
      gsap.to("#isiScroll",1, { marginTop:146,height:419, ease: Power2.easeInOut })
      gsap.to("#isiContainer",1, {height:416, ease: Power2.easeInOut })
      gsap.to(".dash1",1, { rotate:'90deg', ease: Power2.easeInOut })
      isup = true;
  } else {
  gsap.to("#isiScroll",1, { marginTop:382, ease: Power2.easeInOut })
        gsap.to("#isiContainer",1, {height:176, ease: Power2.easeInOut })
