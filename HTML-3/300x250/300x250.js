...
window.onload = function() {   
  ...
  .to(".light-house", .5, {width:470,top:-80, left:-149, ease:Power2.easeInOut}, "frame2+=2")
...
function toggleClass() {
  if(!isup) {
      gsap.to("#isiScroll",1, { marginTop:69,height:167, ease: Power2.easeInOut })
      gsap.to("#isiContainer",1, {height:160, ease: Power2.easeInOut })
      gsap.to(".dash1",1, { rotate:'90deg', ease: Power2.easeInOut })
      isup = true;
  } else {
  gsap.to("#isiScroll",1, { marginTop:168, ease: Power2.easeInOut })
