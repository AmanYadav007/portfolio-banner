...
const animate = () => {
  ...
  tt.set("#banner", { display: "block" })
    ...
    .to("#logo", { duration: 1, opacity: 1, scale: .35, x: -100, y: -86, ease: "power2.inOut" }, "f2")
    .to(["#bgMask"], { duration: 1, opacity: 1, height: 44, ease: "power2.inOut" }, "f2")
    .to(["#bg1"], { duration: 1, opacity: 1, ease: "power2.inOut" }, "f2")
    .to("#badge2,#copy1", { duration: 1, opacity: 1, top: -1, ease: "power2.inOut" }, "f2")


    .addLabel("f3", 6)
    .to(["#steam"], 1, { duration: 1, opacity: 1, x: 143, ease: "power2.inOut" }, "f3")
    ...
    .to(["#steam"], { duration: 1, opacity: 1, x: 608, ease: "power2.inOut" }, "f4+=1.5")
    .to("#copy3", { duration: 1, opacity: 1, top: 1, ease: "power2.inOut" }, "f4+=1.8")

    .addLabel("f5", 15)
    .to(["#steam"], 1, { duration: 1, scale: .7, opacity: 1, x: 490, y: -15, ease: "power2.inOut" }, "f5")
...
function toggleFooter() {
  ...
  const footerHeight = isFooterExpanded ? "86px" : "206px";
  const scrollbarHeight = isFooterExpanded ? "51.5px" : "171.5px";
