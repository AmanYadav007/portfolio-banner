...
const animate = () => {
  ...
  tt.set("#banner", { display: "block" })
    ...
    .addLabel("f2", 2)
    .to(["#steam"], { duration: 1, opacity: 1, x: 1091, ease: "power2.inOut" }, "f2")
    ...
    .to("#logo", { duration: 1, opacity: 1, scale: .34, x: -97, y: -232, ease: "power2.inOut" }, "f2")
    .to(["#bgMask"], { duration: 1, opacity: 1, height: 62, ease: "power2.inOut" }, "f2")
    .to(["#bg1"], { duration: 1, opacity: 1, ease: "power2.inOut" }, "f2")
    .to("#badge2,#copy1", { duration: 1, opacity: 1, top: -1, ease: "power2.inOut" }, "f2")


    .addLabel("f3", 6)
    .to(["#steam"], 1, { duration: 1, opacity: 1, x: 658, y: 50, scale: .9, ease: "power2.inOut" }, "f3")
    ...
    .to(["#steam"], { duration: 1, opacity: 1, x: 1324, y: 47, scale: (0.9, 0.93), ease: "power2.inOut" }, "f4+=1.5")
    .to("#copy3", { duration: 1, opacity: 1, top: 0,left:2, ease: "power2.inOut" }, "f4+=1.8")



    .addLabel("f5", 15)
    .to(["#steam"], 1, { duration: 1, scale: .7, opacity: 1, x: 1493, y: 112, scale: (1.3, 1.32), ease: "power2.inOut" }, "f5")
...
function toggleFooter() {
  ...
  const footerHeight = isFooterExpanded ? "210px" : "537px";
  const scrollbarHeight = isFooterExpanded ? "177px" : "504px";
