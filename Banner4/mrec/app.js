...
function init() {
    ...
    autoAlpha: 1,
	  drawSVG: "0%"
  }, "one").add(drawLine2(), "one").addLabel("two", "+=1").to([line2holder, line1holder, text1, text1a], {
    duration: .5,
    autoAlpha: 0
  }, "two").addLabel("twoA", "+=.25").add(drawLine3(), "twoA").to([logo,text2, text2a], {
    duration: 1.5,
    stagger: .5,
    autoAlpha: 1
  }, "twoA").addLabel("three", "+=1").to([line3holder, text2, text2a], {
    duration: .3,
    autoAlpha: 0
  },
"three").addLabel("threeA", "+=.25").add(drawLine5(), "threeA").to([text3, footnote, "#HandWritten .textReveal", text3b, btn_action], {
                duration: .5,
                stagger: .5,
                autoAlpha: 1,
                drawSVG: "100%"
