...
function init() {
    gsap.registerPlugin(DrawSVGPlugin), new Border(borderHolder, {
        ...
        .set(document.getElementById("handWrittenSub1"), {
            x: 63,
            y: 70
        })
        .set(document.getElementById("handWrittenSub2"), {
            x: -210,
            y: 65
        })
        .addLabel("one").add(drawLine1(), "one").to([logo, text1, text1a], {
            duration: 1.5,
            stagger: .5,
            autoAlpha: 1,
            drawSVG: "0%"
        }, "one").add(drawLine2(), "one").addLabel("two", "+=1").to([logo,line2holder, line1holder, text1, text1a ], {
            duration: .5,
            autoAlpha: 0
            ...
            //     autoAlpha: 1
            // },
            "three").addLabel("threeA", "+=.25").to([logo3,text3, footnote, "#HandWritten .textReveal", text3b, btn_action], {
                duration: .5,
                stagger: .5,
                autoAlpha: 1,
                drawSVG: "100%"
            },
            "three").addLabel("threeA", "+=.25").to([], {
